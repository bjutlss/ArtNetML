...
from utils.custom_pvn3d_eval_utils_kpls import TorchEval
...
parser.add_argument(
    '--test_occ', action="store_true", help="To eval occlusion custom or not."
)
...
def model_fn_decorator(
    ...
    def model_fn(
        ...
        if finish_test:
            teval.cal_custom_add(config.cls_id)
            return None
        if is_eval:
            model.eval()
            ...
            if is_test and test_pose:
                ...
                if not args.test_gt:
                    ...
                    teval.eval_pose_parallel(
                        ...
                        ds='custom', obj_id=config.cls_id,
...
def train():
    ...
    if not args.eval_net:
        ...
        train_loader = torch.utils.data.DataLoader(
            ...
            drop_last=True, num_workers=2, sampler=train_sampler, pin_memory=True
        )
        ...
        val_loader = torch.utils.data.DataLoader(
            ...
            drop_last=False, num_workers=2, sampler=val_sampler
        )
    else:
